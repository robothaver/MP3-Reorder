...
public class MP3Controller extends BaseController<Region> {
    ...
    public MP3Controller() {
        ...
        viewBuilder = new MP3ViewBuilder(model, this::onLoadSongs, interactor::closeDetailsSideMenu, interactor::onPlayNext, interactor::onPlayPrevious, interactor::togglePlay);
